...
def get_xyzR_lines_mono(xyzR_array,machine_type,file_description):
    if machine_type==1:
        mp_num = 40
    elif machine_type==2:
        mp_num = 52
...
def make_gaussview_xyz(auto_dir,monomer_name,params_dict,isInterlayer=False):
    ...
    monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,0,A1,A2,A3, phi1,phib)##1,2がb方向
    ...
    monomer_array_p3 = get_monomer_xyzR(monomer_name,a_,0,0,A1,A2,A3, phi1,phib)##3,4がa方向
    monomer_array_p4 = get_monomer_xyzR(monomer_name,-a_,0,0,A1,A2,A3, phi1,phib)
...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):
    a_ = params_dict['a']; b_ = params_dict['b']; c = np.array([params_dict['cx'],params_dict['cy'],params_dict['cz']])
    A1 = params_dict['A1']; A2 = params_dict['A2']
    ...
    monomer_array_i = get_monomer_xyzR(monomer_name,0,0,0,A1,A2,A3, phi1,phib)
    if a_>b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,R4,A1,A2,A3, phi1,phib)##p1がb方向
        monomer_array_ip1 = get_monomer_xyzR(monomer_name,c[0],c[1]+b_,c[2]+R4,0,0,A3, phi1,phib)
        monomer_array_ip2 = get_monomer_xyzR(monomer_name,c[0],c[1]-b_,c[2]-R4,0,0,A3, phi1,phib)
    else:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,2*R3-R4,A1,A2,A3, phi1,phib)##p2がa方向
        monomer_array_ip1 = get_monomer_xyzR(monomer_name,c[0]+a_,c[1],c[2]+2*R3-R4,0,0,A3, phi1,phib)
        monomer_array_ip2 = get_monomer_xyzR(monomer_name,c[0]-a_,c[1],c[2]-(2*R3-R4),0,0,A3, phi1,phib)
    
    monomer_array_i0 = get_monomer_xyzR(monomer_name,c[0],c[1],c[2],0,0,A3, phi1,phib)
    monomer_array_t1 = get_monomer_xyzR(monomer_name,a_/2,b_/2,R3,-A1,A2,-A3, phi2,phib)
    monomer_array_t2 = get_monomer_xyzR(monomer_name,a_/2,-b_/2,R3-R4,-A1,A2,-A3, phi2,phib)
    monomer_array_t3 = get_monomer_xyzR(monomer_name,-a_/2,-b_/2,-R3,-A1,A2,-A3, phi2,phib)
    monomer_array_t4 = get_monomer_xyzR(monomer_name,-a_/2,b_/2,-R3+R4,-A1,A2,-A3, phi2,phib)
    monomer_array_it1 = get_monomer_xyzR(monomer_name,c[0]+a_/2,c[1]+b_/2,c[2]+R3,0,0,-A3, phi2,phib)
    monomer_array_it2 = get_monomer_xyzR(monomer_name,c[0]+a_/2,c[1]-b_/2,c[2]+R3-R4,0,0,-A3, phi2,phib)
    monomer_array_it3 = get_monomer_xyzR(monomer_name,c[0]-a_/2,c[1]-b_/2,c[2]-R3,0,0,-A3, phi2,phib)
    monomer_array_it4 = get_monomer_xyzR(monomer_name,c[0]-a_/2,c[1]+b_/2,c[2]-R3+R4,0,0,-A3, phi2,phib)
    ...
    line_list_monomer_i = get_xyzR_lines_mono(monomer_array_i,machine_type,file_description+'_i')
    ...
    #    #gij_xyz_lines = ['$ RunGauss\n'] + line_list_dimer_i0 + ['\n\n--Link1--\n'] + line_list_dimer_ip1+ ['\n\n--Link1--\n'] + line_list_dimer_ip2+ ['\n\n--Link1--\n'] + line_list_dimer_ip3+ ['\n\n--Link1--\n'] + line_list_dimer_ip4+ ['\n\n--Link1--\n'] + line_list_dimer_it1 + ['\n\n--Link1--\n'] + line_list_dimer_it2 + ['\n\n--Link1--\n'] + line_list_dimer_it3 + ['\n\n--Link1--\n'] + line_list_dimer_it4 + ['\n\n\n']##2層目9分子
        ...
        gij_xyz_lines = ['$ RunGauss\n'] + line_list_dimer_p1 + ['\n\n--Link1--\n'] + line_list_dimer_t1 + ['\n\n--Link1--\n'] + line_list_dimer_t3  + ['\n\n--Link1--\n'] + line_list_monomer_i  + ['\n\n\n'] ##+ ['\n\n--Link1--\n'] + line_list_dimer_t2 + ['\n\n--Link1--\n'] + line_list_dimer_t4 + ['\n\n\n']
    elif monomer_name=='mono-C4-BTBT':##tshaped ４分子を全て計算
        gij_xyz_lines = ['$ RunGauss\n'] + line_list_dimer_p1 + ['\n\n--Link1--\n'] + line_list_dimer_t1 + ['\n\n--Link1--\n'] + line_list_dimer_t3  + ['\n\n--Link1--\n'] + line_list_monomer_i  + ['\n\n\n'] ##+ ['\n\n--Link1--\n'] + line_list_dimer_t2 + ['\n\n--Link1--\n'] + line_list_dimer_t4 + ['\n\n\n']
