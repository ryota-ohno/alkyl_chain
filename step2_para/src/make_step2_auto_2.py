...
def make_gjf_xyz(auto_dir,monomer_name,params_dict):##計算する際のジョブファイル作成
    a1_ = params_dict['a1']; a2_ = params_dict['a2']; b_ = params_dict['b']; #c = np.array([params_dict['cx'],params_dict['cy'],params_dict['cz']])
    ...
    for z in z_list:
        ...
        monomer_array_t1 = get_monomer_xyzR(monomer_name,a1_/2,b_/2,z,A2,-A3)##誘導体はtが等価でないから4つつくる
        monomer_array_t4 = get_monomer_xyzR(monomer_name,-a2_/2,b_/2,z,A2,-A3)##誘導体はtが等価でないから4つつくる
...
##上で作った文章部分を結合して1か所の計算をまとめる
    ...
    file_base_name += '_step2_a1={}_a2={}_b={}_theta={}_'.format(a1_,a2_,b_,A3)
