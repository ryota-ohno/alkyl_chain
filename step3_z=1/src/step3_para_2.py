...
import pandas as pd
import time
from make_step3_2 import exec_gjf##計算した点のxyzfileを出す
...
def main_process(args):
    ...
    if not os.path.exists(auto_csv_path):        
        df_E = pd.DataFrame(columns = ['cx','cy','cz','theta1','theta2','a1','z1','a2','b2','z2','E','status','machine_type','file_name'])##いじる
...
def listen(auto_dir,monomer_name,num_nodes,max_2,isTest):##args自体を引数に取るか中身をばらして取るかの違い
    ...
    fixed_param_keys = ['theta1','theta2','a1','z1','a2','b2','z2'];opt_param_keys = ['cx','cy','cz']
