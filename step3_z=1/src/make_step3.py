...
def make_xyzfile(monomer_name,params_dict):
    a1 = params_dict.get('a1',0.0); z1 = params_dict.get('z1',0.0); A3 = params_dict.get('theta',0.0)
    ...
    monomer_array_i = get_monomer_xyzR(monomer_name,cx,cy,cz,A3)
    
    monomer_array_0 = get_monomer_xyzR(monomer_name,0,0,0,A3)##1,2がb方向
    monomer_array_1 = get_monomer_xyzR(monomer_name,a1,0,z1,A3)##1,2がb方向
    monomer_array_2 = get_monomer_xyzR(monomer_name,a2,b2,z2,A3)##1,2がb方向
    monomer_array_3 = get_monomer_xyzR(monomer_name,a1+a2,b2,z1+z2,A3)##1,2がb方向
...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type):
    ...
    file_description = f'{monomer_name}_a1={a1}_z1={z1}_a2={a2}_b2={b2}_z2={z2}_theta={A3}_cx={cx}_cy={cy}_cz={cz}'
